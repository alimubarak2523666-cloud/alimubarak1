...
(function () {
  ...
  const SEED = {
    ...
    videos: {
      intro: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
      product: "https://www.youtube.com/watch?v=ScMzIvxBSi4"
    },
    products: [
...
// LIVE TEST MODE: every new device starts completely clean — Ali builds everything from the dashboards
(function(){ if(!localStorage.getItem('theedit_live_x1_init')){ TE.resetEmpty(); localStorage.setItem('theedit_live_x1_init','1'); } })();
