      ...
      <section className="bg-cream-50 border border-cream-400 rounded-[12px] p-10 md:p-12 mb-4">
        <div className="grid md:grid-cols-2 gap-4">
          {cards.map((card) => (
            <div
              key={card.titleKey}
              className="bg-cream-100 border border-cream-400 rounded-card p-6"
            >
      ...
      <section className="bg-cream-50 border border-cream-400 rounded-[12px] p-10 md:p-12">
        ...
        <div className="flex gap-3 flex-wrap">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="border border-emerald-700 text-emerald-700 rounded-md px-5 py-3 text-sm font-medium hover:bg-emerald-700 hover:text-cream-50 transition-colors"
          >
            {t('instagramCta')}
          </a>
          <a
